...
def yearRange():
    years=[]
    #datetime.MINYEAR=2015
    #datetime.MAXYEAR=2016
...
if __name__ == "__main__":
    ...
    minyear = input('Enter the lower bound year for which you want the data ')
    maxyear = input('Enter the upper bound year for which you want the data ')
    countUrl=urlCount()
    toVector()